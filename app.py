...
data_ZH = {
    ...
    'Total Words': [10200, 10050, 10200, 10080, 10120],
    'WWC': [10120, 9830, 8150, 7680, 7520],  # 示例加权字数，可按公司算法再行调整
    'Context Match': [0, 100, 1600, 1800, 2000],
    'Repetitions': [80, 120, 450, 500, 600],
    '101%': [0, 50, 300, 350, 400],
    '100%': [0, 80, 600, 700, 800],
    '95%-99%': [10, 100, 700, 750, 800],
    '85%-94%': [20, 150, 500, 550, 600],
    '75%-84%': [30, 200, 400, 450, 500],
    '50%-74%': [2500, 3500, 250, 200, 200],
    'No Match': [7560, 5750, 5400, 4780, 4220]
}
data_FR = {
    'Month': ['Sep', 'Oct', 'Nov', 'Dec', 'Jan'],
